document.addEventListener('keydown', (event) => {
    ...
    if (key == 65){
        ...
        document.getElementById('65').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function() {
    ...
    if (key == 83){
        ...
        document.getElementById('83').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 68){
        ...
        document.getElementById('68').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 70){
        ...
        document.getElementById('70').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 71){
        ...
        document.getElementById('71').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 72){
        ...
        document.getElementById('72').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 74){
        ...
        document.getElementById('74').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 75){
        ...
        document.getElementById('75').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
    ...
    if (key == 76){
        ...
        document.getElementById('76').style.boxShadow = "0px 0px 20px 0px";
        setTimeout(function(){
